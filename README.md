...
To make the UI between pages consistent, a skeleton branch is made to develop the page skeleton HTML structure, which consists of the **main style and sidebar**. separated into a top and bottom part. To use the skeleton, make the page file as PHP and structure it like this:
```php
