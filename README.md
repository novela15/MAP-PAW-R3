...
It's also possible to use a dummy data by importing the dummy database located in the same directory as the `database_setup.sql`. The dummy database has a single user with `a@a.a` as the email and `123123` as the password.
